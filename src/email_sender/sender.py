...
<div class="container">
  <div class="header">
    <h1>SICA — DAILY INVESTMENT INTELLIGENCE</h1>
  ...
  <div class="footer">
    Generated by SICA &bull; Sage Investor Council Agent
  </div>
</div>
</body>
</html>
...
TEXT_TEMPLATE = """
═══════════════════════════════════════════
  SICA — DAILY INVESTMENT INTELLIGENCE
  Sage Investor Council Agent
  {{ date }}
═══════════════════════════════════════════
...
class EmailSender:
    ...
    def __init__(self, config: dict):
        ...
        self.subject_template = email_config.get("subject", "SICA Daily Intelligence - {date}")
